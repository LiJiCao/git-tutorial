...
// 记录每一轮的新数列
var bfs = function (deadends) {
    // 操作记录
    let memorize = {'0000': 1}
    return function (a, b, c, d, queue) {
        let first1 = changeNumList[a][0] + b + c + d,
            first2 = changeNumList[a][1] + b + c + d,
            second1 = a + changeNumList[b][0] + c + d,
            second2 = a + changeNumList[b][1] + c + d,
            third1 = a + b + changeNumList[c][0] + d,
            third2 = a + b + changeNumList[c][1] + d,
            fourth1 = a + b + c + changeNumList[d][0],
            fourth2 = a + b + c + changeNumList[d][1]
        let newKeyList = [first1, first2, second1, second2, third1, third2, fourth1, fourth2]
        newKeyList.forEach(e => {
            if (!deadends.includes(e) && !memorize.hasOwnProperty(e)) {
                queue.push(e)
                memorize[e] = 1
            }
        })
